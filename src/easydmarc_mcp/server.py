...
def create_mcp_server(settings: Settings) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "easydmarc_list_domains(organization_id=...) to find a domain — or "
            "easydmarc_get_domains_overview when you need each domain's "
            "SPF/DKIM/DMARC/BIMI record status, volume or pass rates, which "
            "list_domains does not carry. Tool "
