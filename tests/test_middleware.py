...
from easydmarc_mcp.__main__ import _build_http_app
from easydmarc_mcp.config import Settings
from easydmarc_mcp.server import create_mcp_server, get_client_from_context
...
def test_health_is_local_and_does_not_require_credentials():
    ...
    with TestClient(app) as client:
        ...
        assert resp.json() == {"status": "ok", "transport": "http", "auth_mode": "gateway"}
